...
// of how Instant-AI is used and how to improve this product!
...
async function setupTelemetry() {
  ...
  console.log(
    `\x1b[32m[TELEMETRY ENABLED]\x1b[0m Anonymous Telemetry enabled. Telemetry helps improve Instant-AI.`
  );
