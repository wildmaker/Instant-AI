  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "Instant-AI | 企业级本地知识库应用平台",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://instant-ai.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://instant-ai.com" },
      },
      {
        tag: "meta",
        props: {
